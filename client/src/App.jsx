      ...
      <nav className="sticky top-0 z-10 backdrop-blur-md supports-[backdrop-filter]:bg-white/80 bg-white/90 border-b border-slate-200/50 shadow-lg">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <span className="text-xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">
            ...
            <span className="text-sm text-slate-600">Easily manage your purchases</span>
          </div>
          <div className="flex items-center gap-3">
            <a
              href="https://youtu.be/tj_whq2d5DM"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
            >
            ...
            <a
              href="https://github.com/theHasanMahmud/Bachelors-Meal-Management"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
